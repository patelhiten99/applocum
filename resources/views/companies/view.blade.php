...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">List of Companies
                    <button type="button" class="btn btn-sm btn-primary company_form" data-id="-1" data-toggle="modal" data-target="#modal-lg" style="float: right">Add Company</button>
                </div>
                <div class="card-body">
...
<script>
    $(function () {
        var Data_table = $("#example").DataTable({
            ...
            "order": [],
            ajax: {
                url: "{{route('admin.companies.getdata')}}", // json datasource
...
//                }
        ...
        $(document).on('click', '.company_form', function () {
            var form_id = $(this).data('id');

            $.ajax({
                url: "{{route('admin.companies.formdata')}}", // json datasource
                type: "POST", // method  , by default get
